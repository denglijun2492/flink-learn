 ...
 */
@Internal
public class MyKafkaConsumerThread extends Thread {

    private MyConsumerMonitor consumerMonitor = new MyConsumerMonitor();
    ...
    public void run() {
        ...
        try {
            ...
            while (running) {
                ...
                try {
                    consumerMonitor.gatherInfo(consumer, records.count());
