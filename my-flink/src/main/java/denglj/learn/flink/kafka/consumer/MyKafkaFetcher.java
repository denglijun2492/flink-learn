 ...
 */
@Internal
public class MyKafkaFetcher<T> extends AbstractFetcher<T, TopicPartition> {
    ...
    private final MyKafkaConsumerThread consumerThread;
    ...
    public MyKafkaFetcher(
        ...
        this.consumerThread = new MyKafkaConsumerThread(
                LOG,
                handover,
                kafkaProperties,
